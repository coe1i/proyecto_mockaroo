...
<table>
 ...
 <td rowspan="7">
    ...
    <td><?=comprobarFotoPerfil($cli->id)?></td></tr>
 <tr><td>first_name:</td> 
...
<tr><td>country:</td>
<td><?=banderaPais($cli->ip_address)?></td></tr>
 <tr><td>ip_address:</td> 
 ...
 <tr><td> ubicacion:</td>
   <td><?=mostrarMapa($cli->ip_address)?></td></tr>
 </table>
...
<input type="submit"	 name="nav-detalles" 	value="pdf">
</form> 
