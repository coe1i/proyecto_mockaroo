...
if ($_SERVER['REQUEST_METHOD'] == "GET" ){
    ...
    if ( isset($_GET['nav-detalles']) && isset($_GET['id']) ) {
     switch ( $_GET['nav-detalles']) {
        ...
        case "pdf" : imprimirPDF($_GET['id']); break;
        
    }
     }
    if ( isset($_GET['nav-modificar']) && isset($_GET['id']) ) {
        switch ( $_GET['nav-modificar']) {
            case "Siguiente": crudModificarSiguiente($_GET['id']); break;; // No hago nada
            case "Anterior" : crudModificarAnterior($_GET['id']); break;; // No hago nada
